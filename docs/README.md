...
| 05 | [枚举与模式匹配](./05-enums-and-pattern-matching.md) | 带数据的枚举、`match` 表达式与穷尽性 | `guessing_game` |
| 06 | [错误处理](./06-error-handling.md) | `Result`、`expect`、自定义错误类型、`map_err`、`?` | `guessing_game` |
| 07 | [Trait](./07-traits.md) | trait 必须导入、`derive`、`Display` vs `Debug`、`impl Trait` 参数 | `guessing_game` |
| 08 | [格式化与宏](./08-formatting-and-macros.md) | 宏为什么带 `!`、内联格式化参数 | `hello_cargo` |
